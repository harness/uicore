...
const Icons = {
  ...
  CommandSwitch,
  CommandWinrm,
  DeploymentAbortedLegacy,
  DeploymentAbortedNew,
  DeploymentFailedLegacy,
  DeploymentFailedNew,
  DeploymentIncompleteLegacy,
  DeploymentIncompleteNew,
  DeploymentInprogressLegacy,
  DeploymentInprogressNew,
  DeploymentPausedLegacy,
  DeploymentPausedNew,
  DeploymentQueuedLegacy,
  DeploymentQueuedNew,
  DeploymentRejectedLegacy,
  DeploymentRejectedNew,
  DeploymentSuccessLegacy,
  ...
  MainHelp,
  MainInfo,
  MainInfrastructureProvisioners,
  MainIssueFilled,
  MainIssue,
  MainLike,
  MainLink,
