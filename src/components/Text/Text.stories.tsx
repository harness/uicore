...
export const Basic: Story<TextProps> = () => {
  return (
    <>
      <Text font={{ kind: FontKind.DISPLAY1 }} tooltip={`<Text font={{ kind: FontKind.DISPLAY1 }}>Display 1</Text>`}>
        Display 1
      </Text>
      <Text font={{ kind: FontKind.DISPLAY2 }} tooltip={`<Text font={{ kind: FontKind.DISPLAY2 }}>Display 2</Text>`}>
        Display 2
      </Text>
      <Text
        font={{ kind: FontKind.H1 }}
      ...
      <Text font={{ kind: FontKind.TINY }} tooltip={`<Text font={{ kind: FontKind.TINY }}>Tiny</Text>`}>
        Tiny
      </Text>
      <Text font={{ kind: FontKind.TINY_SEMI }} tooltip={`<Text font={{ kind: FontKind.TINY_SEMI }}>Tiny Semi</Text>`}>
        Tiny Semi
      </Text>
      <Text font={{ kind: FontKind.YAML }} tooltip={`<Text font={{ kind: FontKind.YAML }}>YAML - YAML Code</Text>`}>
        YAML - YAML Code
      </Text>
      <Text
        font={{ kind: FontKind.CARD_TITLE }}
