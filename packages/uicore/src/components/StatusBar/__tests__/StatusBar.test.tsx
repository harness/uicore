...
describe('StatusBar unit tests', () => {
  test('Render a vertical bar', async () => {
    ...
    await waitFor(() => container.querySelector(`[class*="background-${Color.RED_500}"]`))
  ...
  test.skip('Render a horizontal bar', async () => {
    ...
    await waitFor(() => container.querySelector(`[class*="${gradient}"]`))
    ...
    await waitFor(() => getByText('In Progress'))
