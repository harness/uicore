...
export const Basic: StoryFn = _args => (
...
export const StepSubTitle: StoryFn = _args => (
  <StepWizard
    icon="app-kubernetes"
    iconProps={{ size: 50 }}
...
export const FullExample: StoryFn = _args => <ExampleWizard />

export const ModalStepExample: StoryFn = _args => <ModalExample />

export const Nested: StoryFn = _args => (
  <StepWizard
    title="Kubernetes Cluster"
    subtitle={
...
export const NestedChildSteps: StoryFn = _args => (
