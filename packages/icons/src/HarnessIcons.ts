...
import AiAgentServices from './ai-agent-services.svg'
import AiAgent from './ai-agent.svg'
...
import AiSettings from './ai-settings.svg'
...
import AsgScale from './asg-scale.svg'
...
import BugSmells from './bug-smells.svg'
import BuildDeployment from './build-deployment.svg'
...
import ChaosActions from './chaos-actions.svg'
...
import CisLight from './cis-light.svg'
...
import Decompiler from './decompiler.svg'
...
import DependencyCiStepInverse from './dependency-ci-step-inverse.svg'
...
import FmeInstructions from './fme-instructions.svg'
...
import FmeSegmentUpdateRules from './fme-segment-update-rules.svg'
import FmeSegmentsAddRemoveTargets from './fme-segments-add-remove-targets.svg'
...
import HarWithDarkText from './har-with-dark-text.svg'
...
import Impersonate from './impersonate.svg'
...
import IrReadiness from './ir-readiness.svg'
...
import ManualRun from './manual-run.svg'
...
import NavStoIssues from './nav-sto-issues.svg'
...
import NexusiqInverse from './nexusiq-inverse.svg'
import Nexusiq from './nexusiq.svg'
...
import PipelineExecutor from './pipeline-executor.svg'
import PipelineNg from './pipeline-ng.svg'
import PipelineOutputs from './pipeline-outputs.svg'
...
import RestoreCacheHarnessCiStepInverse from './restore-cache-harness-ci-step-inverse.svg'
import RestoreCacheHarnessCiStep from './restore-cache-harness-ci-step.svg'
import RestoreCacheS3CiStepInverse from './restore-cache-s3-ci-step-inverse.svg'
import RestoreCacheS3CiStep from './restore-cache-s3-ci-step.svg'
...
import SaveCacheHarnessCiStep from './save-cache-harness-ci-step.svg'
import SaveCacheS3CiStepInverse from './save-cache-s3-ci-step-inverse.svg'
import SaveCacheS3CiStep from './save-cache-s3-ci-step.svg'
...
import StatusExtendFilled from './status-extend-filled.svg'
import StatusExtend from './status-extend.svg'
...
import SteadyState from './steady-state.svg'
...
import StoIacGrey from './sto-iac-grey.svg'
...
import TraceableDiscovery from './traceable-discovery.svg'
...
type HarnessIconName =
  ...
  | 'fme-rollout-board'
  | 'fme-search'
  | 'fme-segment-update-rules'
  | 'fme-segments-add-remove-targets'
  | 'fme-segments-create'
  | 'fme-segments-delete'
...
const HarnessIcons: KVO<ElementType> = {
  ...
  agents: Agents,
  aggre: Aggre,
  'ai-agent-services': AiAgentServices,
  'ai-agent': AiAgent,
  ...
  'dependency-ci-step-inverse': DependencyCiStepInverse,
  ...
  'fme-instructions': FmeInstructions,
  ...
  'fme-segment-update-rules': FmeSegmentUpdateRules,
  'fme-segments-add-remove-targets': FmeSegmentsAddRemoveTargets,
  ...
  'har-with-dark-text': HarWithDarkText,
  ...
  'nexusiq-inverse': NexusiqInverse,
  nexusiq: Nexusiq,
  'ng-filter': NgFilter,
  ...
  'restore-cache-harness-ci-step-inverse': RestoreCacheHarnessCiStepInverse,
  'restore-cache-harness-ci-step': RestoreCacheHarnessCiStep,
  'restore-cache-s3-ci-step-inverse': RestoreCacheS3CiStepInverse,
  'restore-cache-s3-ci-step': RestoreCacheS3CiStep,
  ...
  'save-cache-harness-ci-step': SaveCacheHarnessCiStep,
  'save-cache-s3-ci-step-inverse': SaveCacheS3CiStepInverse,
  'save-cache-s3-ci-step': SaveCacheS3CiStep,
  ...
  'status-extend-filled': StatusExtendFilled,
  'status-extend': StatusExtend,
  ...
  'traceable-discovery': TraceableDiscovery,
  ...
  'ts-logo': TsLogo,
  'union-vertical': UnionVertical,
  union: Union,
  university: University,
  up: Up,
  'update-app': UpdateApp,
  'upgrade-bolt': UpgradeBolt,
  'upgrade-custom': UpgradeCustom,
