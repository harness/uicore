...
const getYoutubeThumbnailURL = (id: string): string => `https://img.youtube.com/vi/${id}/hqdefault.jpg`
  ...
  return (
    <Container margin={{ top: 'medium' }}>
      <a href={getYoutubeRedirectionURl(id)} target="_blank" rel="noreferrer">
        <img src={getYoutubeThumbnailURL(id)} height={thumbnailHeight} width={thumbnailWidth} />
      </a>
    </Container>
  )
}
