...
```js
import { CollapseList, CollapseListPanel } from '@wings-software/uicore'
```
...
<CollapseList>
  <CollapseListPanel
    ...
    Hello world The quick brown fox jumps over the lazy dog The quick brown fox jumps over the lazy dog The quick brown
