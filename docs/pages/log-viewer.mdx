...
import {LogsViewerExampleLoader} from '../shared/LogsViewerExampleLoader.tsx'
...
<LogsViewerExampleLoader limit={5} />
...
<LogsViewerExampleLoader isLoading />
