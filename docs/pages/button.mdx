...
<Layout.Horizontal>
  <ConfirmActionButton
    ...
    message="Are you sure you want to a pause this execution? This action cannot be undo."
    cancelText="Cancel"
    confirmText="Confirm"
  ...
  <ConfirmActionButton
    ...
    icon="stop"
    title="Confirm Action"
    message="Are you sure you want to a abort this execution? This action cannot be undo."
    cancelText="Cancel"
    confirmText="Confirm"
    onClick={() => alert('Action is confirmed')}
  />
