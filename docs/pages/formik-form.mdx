...
<Formik
  ...
  {formikProps => {
    return (
      <FormikForm>
        <FormInput.InputWithIdentifier isIdentifierEditable={false} inputGroupProps={{ placeholder: 'Type here to generate Identifier' }} />
...
<Formik
  ...
  <FormikForm>
    ...
    />
    <FormInput.TextArea name="description" label="Description" />
    <FormInput.MultiTypeInput name="job" label="Job" selectItems={[{label: 'Software Engineer', value: 'SE'}, { label: 'Quality Engineer', value: 'QE' }]}/>
    <FormInput.MultiSelectTypeInput name="hobbies" label="Hobbies" selectItems={[{label: 'Basket Ball', value: 'BBall'}, { label: 'Drawing', value: 'Drawing' }]}/>
    <FormInput.CategorizedSelect name="sportsAndPokemon" label="Sports and Pokemon" items={[
    ...
    categorizedSelectProps={{
            creatableOption: {
              creatableOptionLabel: 'Custom Query',
