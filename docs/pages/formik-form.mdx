...
<Formik 
    ...
    <FormikForm>
        ...
        <FormInput.Select name="color" label="Color" placeholder="Select Color" items={[{label: 'Red', value: 'red'}, {label: 'Blue', value: 'blue'}]}/>
        <FormInput.MultiSelect name="colorMulti" label="Color Multi" placeholder="Select Multiple Colors" items={[{label: 'Red', value: 'red'}, {label: 'Blue', value: 'blue'}]}/>
        <FormInput.TextArea name="description" label="Description" />
        <Button intent="primary" type="Submit" text="Submit" />
    </FormikForm>
</Formik>
