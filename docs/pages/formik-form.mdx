...
<Formik
  ...
  <FormikForm>
    ...
    />
    <FormInput.TextArea name="description" label="Description" />
    <FormInput.MultiTypeInput name="job" label="Job" items={[{label: 'Software Engineer', value: 'SE'}, { label: 'Quality Engineer', value: 'QE' }]}/>
    <FormInput.MultiSelectTypeInput name="hobbies" label="Hobbies" items={[{label: 'Basket Ball', value: 'BBall'}, { label: 'Drawing', value: 'Drawing' }]}/>
    <Button intent="primary" type="Submit" text="Submit" />
  </FormikForm>
</Formik>
```
